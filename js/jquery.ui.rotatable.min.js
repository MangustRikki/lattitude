 ...
 *
 * В код внесено изменение: getElementCenter в оригинале позвращал центр только в случае, если он не был определен.
 * Я убрал условие проверки, т.к. центр не переопределялся при перемещении объекта, из-за чего далее вращение
 * происходило некорректно.
 */
...
getElementCenter:function(){this.elementCenter=this._calculateElementCenter();return this.elementCenter},handle:function(a){if(void 0===a)return this.options.handle;this.options.handle=a},plugins:{},rotationCenterOffset:function(a){if(void 0===a)return this.options.rotationCenterOffset;null!==a.top&&(this.options.rotationCenterOffset.top=a.top);null!==a.left&&(this.options.rotationCenterOffset.left=a.left)},rotateElement:function(a){if(!this.element||this.element.disabled||
